...
"[project]/src/app/api/admin/update-delegate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        // Parse request body
        const { type, id, allotment_committee, allotment_portfolio, paid } = await req.json();
        ...
        const collection = db.collection(type === "external" ? "external" : "internal");
        // Update the document
...
//# sourceMappingURL=%5Broot-of-the-server%5D__248b914b._.js.map